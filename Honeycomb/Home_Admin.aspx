<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Home_Admin.aspx.cs" Inherits="Honeycomb.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="flexbox">
        <div class="container">
            ...
            <h2>Welcome, <span class="highlighted">Administrator.</span></h2>
            <br />
